...
def plot(data,num_bins):
    ...
    plt.hist(kscank,bins=num_bins,label=np.percentile(data,percentile),density=1,stacked=1) #density - integrates to 1 , stacked sums to 1
    plt.legend()
    get_os()
